...
export const projectsData: Project[] = [
  {
    ...
    techStack: ['Python', 'TensorFlow', 'Keras', 'CNN', 'Albumentations', 'Gradio'],
    metrics: '12 classes • ~2,400 images • 99.5% accuracy on test data',
  ...
  },
  {
    ...
    description:
      'UI/UX design project for a restaurant ordering application.',
    longDescription:
